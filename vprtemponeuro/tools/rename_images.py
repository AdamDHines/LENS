...
directory_path = '/home/adam/repo/VPRTempoNeuro/vprtemponeuro/dataset/daytime_decay_refined'  # Replace with your directory path
...
for index, filename in enumerate(filenames):
    ...
    new_filename = f'image_{index:04}.png'
